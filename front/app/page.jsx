          ...
          <div className="md:w-1/2 mb-10 md:mb-0">
            ...
            {!auth?.user && (
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Link href="/login" className="bg-white text-green-600 border-2 border-green-600 hover:bg-green-50 font-semibold py-3 px-6 rounded-lg transition-colors text-center">
                  Já tenho uma conta
                </Link>
              </div>
            )}
      ...
      <section className="py-16 px-4 md:px-8 lg:px-16">
        <div className="container mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-12">
            Por que escolher o FinanciAS?
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white p-8 rounded-xl shadow-md hover:shadow-lg transition-shadow hover:-translate-y-1 duration-300">
