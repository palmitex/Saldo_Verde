  ...
  return (
    <div className="bg-gradient-to-b from-gray-50 to-gray-100 min-h-screen py-8 max-w-7xl mx-auto">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center mb-8 bg-white p-6 rounded-xl shadow-md border-l-4 border-green-500 animate-fadeIn">
          ...
          <div className="bg-white rounded-2xl shadow-md p-12 text-center border border-gray-200 animate-pulse">
            <div className="flex justify-center mb-6">
              <div className="bg-green-50 p-5 rounded-full">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12 text-green-400 animate-spin" fill="none" viewBox="0 0 24 24" stroke="currentColor">
