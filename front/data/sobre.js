const sobres = [
    ...
    },
    {
        id: 2,
        indice: 2,
        titulo: 'Qual a Nossa Missão?',
        img: '/sobre2.svg',
        texto: 'Nossa missão é ajudar estudantes a organizarem suas finanças de maneira clara e eficaz, incentivando hábitos saudáveis desde cedo. Acreditamos que com as ferramentas certas, qualquer pessoa pode melhorar sua relação com o dinheiro e conquistar maior autonomia financeira.',
    },
    {
        id: 3,
        indice: 3,
    ...
    },
    {
        id: 6,
        indice: 6,
        titulo: 'Quais São os Benefícios?',
        img: '/sobre6.svg',
        texto: 'Além de controlar suas finanças, você recebe orientações práticas sobre como economizar, evitar dívidas e até começar a poupar. Também oferecemos conteúdo educativo, desafios mensais e uma comunidade de apoio que cresce junto com você.',
    },
    {
        id: 7,
        indice: 7,
